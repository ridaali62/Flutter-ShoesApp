...
import '../save/save_provider.dart';
                  ...
                  Expanded(
                    child: Container(
                        ...
                        decoration: const BoxDecoration(
                          ...
                          color: Color.fromRGBO(57, 73, 192, 1),
                        ),
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              MyText(
                                text: (widget.text ?? 'Nike Dynamic Fit') +
                                    '      \$' +
                                    widget.price,
                                c: Colors.white,
                                fsize: 18,
                              ...
                              MyText(
                                  text: " Sneakers Shoe Air Jordan, men shoes,",
                                  c: const Color.fromRGBO(153, 169, 187, 1),
                                  fsize: 15,
                                  w: FontWeight.normal),
                              const SizedBox(
                                height: 5,
                              ...
                              MyText(
                                  text: "Outdoor Shoe , lemon and black combo ",
                                  c: const Color.fromRGBO(153, 169, 187, 1),
                                  fsize: 15,
                                  w: FontWeight.normal),
                              const SizedBox(
